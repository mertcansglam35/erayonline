                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $randevu->isim_soyisim; ?></td>
                                                <td><?php echo $randevu->email; ?></td>
                                                <td><?php echo $randevu->telefon; ?></td>
                                                <td><?php echo $randevu->servis_secimi; ?></td>
                                                <td><?php echo $randevu->tarih; ?></td>
                                                <td><?php echo $randevu->saat; ?></td>
                                                <td>
                                                    <a href="<?php echo base_url("admin/randevu_delete/$randevu->id") ?>" class="btn btn-danger">Sil</a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
